...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sp = new LatLng(-23.5524087, -46.6580719);
        mMap.addMarker(new MarkerOptions().position(sp).title("Home SP"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(sp,15f));
    ...
    private void enableMyLocation(){
        String[] permission = Arrays.asList(Manifest.permission.ACCESS_FINE_LOCATION)
